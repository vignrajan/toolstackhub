  ...
  '@graph': [
    {
      ...
      name: 'Remove Duplicate Paragraphs Online Free – Clean Repeated Blocks',
      description: 'Remove duplicate paragraphs from any text online free. Paste your content and instantly remove repeated paragraph blocks. No signup. Try now!',
      url: `${SITE_CONFIG.url}/remove-duplicate-paragraphs`,
...
export default function Page() {
  return (
    <>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <nav aria-label="Breadcrumb" className="mb-4">
              <ol className="flex items-center gap-2 text-sm text-surface-500">
                ...
                <li><span className="text-surface-300">/</span></li>
                <li className="text-surface-800 font-medium truncate">Remove Duplicate Paragraphs Online – Remove Repeated Paragraph Blocks</li>
              </ol>
            </nav>
            <h1 className="font-display font-bold text-3xl sm:text-4xl text-surface-950 mb-3 tracking-tight">
              Remove Duplicate Paragraphs Online – Remove Repeated Paragraph Blocks
            </h1>
            <p className="text-surface-500 text-lg leading-relaxed max-w-3xl">
              Removes entire duplicate paragraph blocks from your text. Each paragraph (separated by a blank line) is treated as one unit. Useful for cleaning duplicate sections in long-form content, removing repeated boilerplate in legal or technical documents, and deduplicating scraped web content.
            </p>
      ...
      <RelatedToolsCluster currentSlug="remove-duplicate-paragraphs" />
      <Footer />
    </>
  );
}
