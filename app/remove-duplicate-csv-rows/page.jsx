  ...
  '@graph': [
    {
      ...
      name: 'Remove Duplicate CSV Rows Online Free – Clean CSV Data Instantly',
      description: 'Remove duplicate rows from CSV data online free. Paste your CSV and get unique rows instantly. Supports comma, semicolon, and tab delimiters. No signup.',
      url: `${SITE_CONFIG.url}/remove-duplicate-csv-rows`,
...
export default function Page() {
  return (
    <>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <nav aria-label="Breadcrumb" className="mb-4">
              <ol className="flex items-center gap-2 text-sm text-surface-500">
                ...
                <li><span className="text-surface-300">/</span></li>
                <li className="text-surface-800 font-medium truncate">Remove Duplicate CSV Rows Online – Clean Duplicate Rows from CSV Data</li>
              </ol>
            </nav>
            <h1 className="font-display font-bold text-3xl sm:text-4xl text-surface-950 mb-3 tracking-tight">
              Remove Duplicate CSV Rows Online – Clean Duplicate Rows from CSV Data
            </h1>
            <p className="text-surface-500 text-lg leading-relaxed max-w-3xl">
              Paste CSV data and remove all duplicate rows instantly. Each full row is compared as a unit — a row is only considered a duplicate if every column value matches exactly. Use this before importing data into a database, spreadsheet, or CRM to prevent duplicate record issues.
            </p>
      ...
      <RelatedToolsCluster currentSlug="remove-duplicate-csv-rows" />
      <Footer />
    </>
  );
}
