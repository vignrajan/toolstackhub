...
const SOCIAL_LINKS = [
  {
    label: 'GitHub',
    href: 'https://github.com/REPLACE_WITH_REAL', /* TODO: Replace with real profile URL */
  ...
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/in/REPLACE_WITH_REAL', /* TODO: Replace with real profile URL */
    rel: 'me noopener noreferrer',
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
  ...
  {
    label: 'X / Twitter',
    href: 'https://x.com/REPLACE_WITH_REAL', /* TODO: Replace with real profile URL */
    rel: 'me noopener noreferrer',
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
...
const EXPERTISE = [
  {
    ...
    tags: ['Next.js 14', 'React', 'TypeScript', 'Tailwind CSS', 'Node.js', 'App Router'],
  },
  {
    icon: '💰',
    title: 'Indian Finance Tools',
    tags: ['Income Tax', 'GST', 'PPF', 'HRA', 'EMI', 'Salary Calculators', 'Professional Tax'],
  },
  {
    icon: '🔍',
    title: 'SEO & Content',
    tags: ['Technical SEO', 'Schema Markup', 'Programmatic SEO', 'E-E-A-T', 'Content Strategy'],
  },
  {
    icon: '🛡️',
    title: 'Privacy-First Architecture',
    tags: ['Browser-side processing', 'Zero uploads', 'No auth required', 'localStorage only'],
  },
  {
    icon: '🤖',
    title: 'AI & Prompt Engineering',
    tags: ['Claude', 'ChatGPT', 'Prompt techniques', 'Token optimization', 'AI tool reviews'],
  },
  {
    icon: '🧰',
    title: 'Developer Utilities',
    tags: ['JSON tools', 'Base64', 'Regex', 'UUID', 'Text processing', 'QR codes'],
  },
];
...
const RECENT_ARTICLES = [
  ...
  { title: 'Income Tax Changes 2026 India — New Rules, Slabs & April 1 Impact',    date: 'Mar 30, 2026', category: 'Income Tax', href: '/blog/income-tax-changes-2026-india'                  },
  ...
  { title: 'Claude Prompt Techniques That Actually Work — Expert Guide (2026)',     date: 'Apr 1, 2026',  category: 'AI Tools',   href: '/blog/claude-prompt-techniques'                       },
...
export default function GarryAuthorPage() {
  const jsonLd = {
    ...
    mainEntity: {
      ...
      name: 'Garry',
      url: 'https://www.toolstackhub.in/about/garry',
      /* TODO: Replace image URL once real photo is added */
      ...
      sameAs: [
        'https://github.com/REPLACE_WITH_REAL',    /* TODO: Replace with real GitHub URL */
        'https://linkedin.com/in/REPLACE_WITH_REAL', /* TODO: Replace with real LinkedIn URL */
        'https://x.com/REPLACE_WITH_REAL',           /* TODO: Replace with real Twitter/X URL */
      ],
    },
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-14">
          ...
          <section>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-8">
              {/* Photo — replace the div below with a real <img> tag when you have a photo */}
              {/* TODO: Replace this placeholder div with:
                  <img src="/images/garry.jpg" alt="Garry — Developer at ToolStackHub"
                    width={150} height={150}
                    className="w-36 h-36 sm:w-40 sm:h-40 rounded-full object-cover border-2 border-surface-600 shrink-0" />
              */}
              <div className="w-36 h-36 sm:w-40 sm:h-40 rounded-full bg-brand-600 border-2 border-surface-600 flex items-center justify-center shrink-0">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 text-sm text-surface-500 mb-4 flex-wrap">
                  ...
                  {SOCIAL_LINKS.map(s => (
                    <a key={s.label} href={s.href} rel={s.rel} target="_blank"
          ...
          <section>
            ...
            <div className="space-y-4 text-surface-600 leading-relaxed max-w-3xl">
              ...
              <p>
                My background is in web development. I work primarily with Next.js, React, TypeScript, and Tailwind CSS. I've been building on the web for years, but ToolStackHub is the project I'm most serious about — it's where I put tools I actually use myself and think other people will find genuinely helpful.
              </p>
              <p>
                Most of my focus right now is on two verticals: <strong className="text-surface-800">Indian finance tools</strong> (salary calculators, tax regime comparisons, HRA and PPF calculators) and <strong className="text-surface-800">developer utilities</strong> (JSON formatters, text repeaters, base64 encoders, QR generators). The finance tools are particularly interesting to me because Indian tax rules change every year and most online calculators are months behind. I try to keep everything updated as soon as rules change.
              </p>
              <p>
                The architecture principle I care about most is browser-first processing. When you use a tool on this site, your data never leaves your device. No API calls with your salary figures, no server-side processing of your invoice details. This isn't just a marketing claim — it's how the code is actually written. If you open the browser DevTools and check the network tab, you'll see what I mean.
              </p>
              <p>
                I also write about tax, productivity, and AI tools when I find something worth documenting. The blog is an extension of the same philosophy — practical, specific, and written from actual experience using the things I'm writing about.
              </p>
              <p>
                If you've got a tool idea, found a bug, or just want to say hello — I'm reachable. Links above.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="mt-4">
              <Link href="/" className="inline-flex items-center gap-2 text-sm text-brand-600 hover:text-brand-700 font-semibold transition-colors">
                View all tools →
              </Link>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="mt-4">
              <Link href="/blog" className="inline-flex items-center gap-2 text-sm text-brand-600 hover:text-brand-700 font-semibold transition-colors">
                View all articles →
              </Link>
            </div>
          </section>
          ...
          <section className="bg-surface-50 border border-surface-200 rounded-2xl p-8 text-center">
            ...
            <p className="text-surface-500 text-sm leading-relaxed mb-5 max-w-md mx-auto">
              ...
              Reach me on LinkedIn or Twitter, or use the contact page.
            </p>
            <div className="flex items-center justify-center gap-3 flex-wrap">
              <a href="https://linkedin.com/in/REPLACE_WITH_REAL" /* TODO: Replace with real LinkedIn URL */
              ...
              <a href="https://x.com/REPLACE_WITH_REAL" /* TODO: Replace with real Twitter/X URL */
                rel="me noopener noreferrer" target="_blank"
