...
const DEV_TOOLS = [
  ...
  { href: '/json-to-csv-converter',      icon: '📊',  name: 'JSON to CSV',             desc: 'Convert JSON arrays to CSV format with custom delimiters.' },
  ...
  { href: '/binary-to-decimal-converter', icon: '💻', name: 'Binary Converter',        desc: 'Convert between binary, decimal, octal, and hexadecimal.' },
  ...
  { href: '/unix-timestamp-converter',   icon: '⏱️',  name: 'Timestamp Converter',    desc: 'Convert between Unix timestamps and human-readable dates.' },
