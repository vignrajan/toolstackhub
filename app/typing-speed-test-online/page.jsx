  ...
  '@graph': [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Typing Speed Test', item: `${SITE_CONFIG.url}/typing-speed-test-online` },
      ],
    },
  ],
};
