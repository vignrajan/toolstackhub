export const blogPosts = [
  ...
  {
    slug:        'old-vs-new-regime-15-lpa-salary-2026-27',
    title:       'Old vs New Regime for 15 LPA Salary — FY 2026-27 (Exact Numbers)',
    metaTitle:   'Old vs New Regime for 15 LPA Salary — FY 2026-27',
    metaDesc:    'Which tax regime saves more on a 15 LPA salary? Full FY 2026-27 comparison with exact calculations, monthly in-hand, and break-even deduction amount.',
    excerpt:     'New regime saves ₹29,223/year at 15 LPA — unless your total deductions exceed ₹5,79,330. Step-by-step calculation, HRA exemption formula, and scenario-based verdict.',
    category:    'Income Tax',
    categorySlug:'income-tax',
    author:      'ToolStackHub Finance Team',
    ...
    readTime:    12,
    coverEmoji:  '⚖️',
    coverBg:     'from-brand-600 to-indigo-700',
    tags:        ['income tax', '15 lpa', 'old regime', 'new regime', 'salary', 'FY 2026-27', 'tax comparison'],
    toolUrl:     '/salary-calculator',
    toolName:    'Salary Calculator',
    featured:    true,
    pinned:      false,
    ...
    seasonal:    true,
    seasonPeak:  'April–July 2026',
    urgencyTag:  'FY 2026-27',
  },
  {
    slug:        'indieappcircle-review',
    title:       'IndieAppCircle Review (2026): Get Early Users & Honest Feedback for Your App',
    metaTitle:   'IndieAppCircle Review (2026): Get Early Users & Honest Feedback for Your App',
    metaDesc:    'Honest IndieAppCircle review. How the credit-based feedback platform helps indie developers validate MVPs and get real early users — free.',
    excerpt:     'IndieAppCircle uses a credit-based system to give indie developers structured, honest app feedback from real developers. Built solo by Luis, grown on Reddit, ships daily. Here\'s the honest review.',
    category:    'AI Tools',
    categorySlug:'ai-tools',
    author:      'ToolStackHub AI Team',
    ...
    coverEmoji:  '🔄',
    coverBg:     'from-indigo-600 to-violet-700',
    tags:        ['indie dev', 'mvp validation', 'app feedback', 'indie hacker', 'saas tools'],
    toolUrl:     '/ai-tools',
    toolName:    'AI Tools Hub',
    featured:    true,
    pinned:      false,
  ...
  {
    slug:        'how-to-calculate-hra-exemption-fy-2026-27',
    title:       'How to Calculate HRA Exemption FY 2026-27 — New 8 Metro Cities Rule Explained',
    metaTitle:   'How to Calculate HRA Exemption FY 2026-27 — New 8 Metro Cities Rule',
    metaDesc:    'Complete HRA exemption guide for FY 2026-27. New 8-metro-city rule, Section 10(13A) formula, step-by-step examples, and ideal rent to maximise exemption.',
    excerpt:     'Bengaluru, Pune, Hyderabad & Ahmedabad now qualify for 50% HRA rate from April 2026. Full Section 10(13A) formula, two worked examples, ideal rent calculation, and mistakes that cost you money.',
    category:    'Income Tax',
    categorySlug:'income-tax',
    author:      'ToolStackHub Finance Team',
    ...
    coverEmoji:  '🏠',
    coverBg:     'from-brand-600 to-indigo-700',
    tags:        ['hra', 'income tax', 'metro cities', 'section 10 13a', 'FY 2026-27', 'salary'],
    toolUrl:     '/hra-calculator',
    toolName:    'HRA Exemption Calculator',
    featured:    true,
    pinned:      false,
    trending:    true,
    seasonal:    true,
