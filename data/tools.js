...
},
{
  ...
  category:    'utility',
  icon:        '🧾',
  description: 'Calculate TDS on salary, rent, professional fees, contractor payments, FD interest, and commission for FY 2025-26. Section-wise rates, thresholds, and no-PAN 20% rule. Free, instant, no signup.',
  longDescription: 'Calculate Tax Deducted at Source (TDS) for any payment under the Income Tax Act, FY 2025-26 (AY 2026-27). Supports Section 192 (salary, slab-based), 194-I (rent), 194J (professional/technical fees), 194C (contractor), 194A (bank FD interest), and 194H (commission). Each section comes pre-loaded with the correct rate and exemption threshold, applies the 20% no-PAN rule under Section 206AA, and shows the exact TDS amount and net payment instantly.',
  keywords: ['tds calculator', 'tds calculator online', 'tds calculator fy 2025-26', 'tds on salary calculator', 'tds on rent calculator', 'tds on professional fees', 'tds on contractor payment', 'section 194j tds', 'section 194c tds', 'tds rate calculator india'],
  howToUse: [
    'Select the type of payment — salary, rent, professional fees, contractor, FD interest, or commission',
    'Enter the payment amount (annual for salary, rent, and interest)',
    'Set whether the payee has provided a PAN (no PAN means 20% TDS)',
    'See the exact TDS rate, TDS amount, and net payment instantly',
  ],
  faqs: [
    { q: 'What is TDS?', a: 'TDS (Tax Deducted at Source) is income tax collected at the point of payment. The payer deducts a percentage before paying, deposits it with the government, and the payee claims it as credit while filing their ITR.' },
    { q: 'What is the TDS rate for FY 2025-26?', a: 'It depends on the payment type: salary is taxed as per slab (Section 192), rent at 10% (194-I), professional fees at 10% (194J), contractor payments at 1–2% (194C), FD interest at 10% (194A), and commission at 2% (194H).' },
    { q: 'What happens if the payee has no PAN?', a: 'Under Section 206AA, if the payee does not furnish a PAN, TDS is deducted at the higher of the normal rate or 20%. This does not apply to salary in the same way, but employees should always share a valid PAN.' },
    { q: 'Is salary TDS a flat rate?', a: 'No. TDS on salary equals your estimated annual income tax (new regime by default for FY 2025-26) divided by 12. This calculator estimates it using the FY 2025-26 slabs, ₹75,000 standard deduction, and 87A rebate.' },
    { q: 'Can I get the deducted TDS back?', a: 'Yes. TDS is advance tax. You can claim full credit for it (shown in Form 26AS / AIS) when filing your income tax return, and any excess is refunded.' },
  ],
  relatedSlugs: ['salary-calculator', 'form-16-calculator', 'hra-calculator', 'professional-tax-calculator'],
},
{
  ...
  category:    'utility',
  icon:        '🧮',
  description: 'Calculate income tax for FY 2025-26 (AY 2026-27) under the new and old regime. Instant new-vs-old comparison, slab breakdown, 87A rebate, and recommended regime. Free, no signup.',
  longDescription: 'Calculate your income tax for FY 2025-26 (AY 2026-27) in seconds. Enter your annual income to compare the new tax regime (revised Budget 2025 slabs with the ₹12 lakh Section 87A rebate and ₹75,000 standard deduction) against the old regime with your deductions. Shows tax under both regimes side by side, the recommended option, your savings, effective tax rate, and monthly tax. Includes marginal relief just above ₹12 lakh.',
  keywords: ['income tax calculator', 'income tax calculator fy 2025-26', 'income tax calculator ay 2026-27', 'new vs old regime calculator', 'income tax on salary', 'tax calculator india', 'new regime tax calculator', '87a rebate calculator', 'how much income tax on salary'],
  howToUse: [
    'Enter your annual gross salary or total income',
    'Enter the deductions you claim under the old regime (80C, 80D, NPS, HRA)',
    'See income tax under the new and old regime side by side',
    'Pick the recommended regime to minimise your tax',
  ],
  faqs: [
    { q: 'What are the new income tax slabs for FY 2025-26?', a: 'Under the new regime: nil up to ₹4L, 5% (₹4–8L), 10% (₹8–12L), 15% (₹12–16L), 20% (₹16–20L), 25% (₹20–24L), and 30% above ₹24L. A ₹75,000 standard deduction and the Section 87A rebate (up to ₹12L taxable) apply.' },
    { q: 'How much salary is tax-free in the new regime?', a: 'Salary up to ₹12,75,000 is effectively tax-free under the new regime for FY 2025-26 — the ₹12 lakh rebate limit plus the ₹75,000 standard deduction.' },
    { q: 'Is the new or old regime better?', a: 'It depends on your deductions. With low deductions the new regime usually wins; if you claim large deductions (80C, 80D, HRA, home loan interest), the old regime can be cheaper. This calculator compares both for your numbers.' },
    { q: 'What is marginal relief above ₹12 lakh?', a: 'Just above ₹12 lakh taxable, marginal relief caps your new-regime tax at the amount of income exceeding ₹12 lakh, so a small raise does not trigger a disproportionate tax jump.' },
    { q: 'Does this include cess?', a: 'Yes. A 4% Health & Education Cess is added to the income tax under both regimes.' },
  ],
  relatedSlugs: ['salary-calculator', 'form-16-calculator', 'tds-calculator', 'hra-calculator'],
},
{
  slug: 'ppf-calculator',
  name: 'PPF Calculator',
